...
function Navbar() {
  ...
  return (
    <>
      <header className={`flex bg-white shadow-md sticky top-0 z-10 py-2 ${isMenuOpen ? '' : 'sticky'}`}>
  ...
  function NavbarList(){
    return (
      ...
      <ul className="hidden md:flex space-x-6 text-gray-700">
            ...
            <li className="relative flex items-center space-x-1 hover:text-gray-900">
              <Link to="/media">Arsip Surat</Link>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                viewBox="0 0 20 20"
            ...
            <li><Link to="/Informasi" className="hover:text-gray-900">Informasi</Link></li>
          </ul>
          <div id="login" className="hidden p-2 pt-1 rounded-2xl items-center md:flex">
      ...
      <aside id="menuAside" className={`fixed left-0 w-full h-full bg-black bg-opacity-30 z-20 top-0 ${isMenuOpen ? '' : 'hidden'}`}>
        <div className="flex flex-col h-full w-2/3 bg-white">
          <ul className="flex flex-col space-y-4 pl-8 pt-4">
            <li className="relative flex items-center space-x-1 hover:text-gray-900">
              <Link to="/Transactions">Profil Desa</Link>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                viewBox="0 0 20 20"
