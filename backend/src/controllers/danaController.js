...
const addDanaMasuk = async (req, res) => {
  try {
    ...
    const result = await danaServices.addDanaMasuk(
      tahun,
      bulan,
      jumlah,
      sumber,
...
const addDanaKeluar = async (req, res) => {
  try {
    ...
    const result = await danaServices.addDanaKeluar(
      tahun,
      bulan,
      jumlah,
      kategori,
...
const updateDanaMasuk = async (req, res) => {
  try {
    const { id } = req.params;
    const { tahun, bulan, jumlah, sumber, keterangan } = req.body;
    const result = await danaServices.updateDanaMasuk(
      id,
      tahun,
      bulan,
      jumlah,
...
const updateDanaKeluar = async (req, res) => {
  try {
    const { id } = req.params;
    const { tahun, bulan, jumlah, kategori, keterangan } = req.body;
    const result = await danaServices.updateDanaKeluar(
      id,
      tahun,
      bulan,
      jumlah,
