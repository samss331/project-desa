...
router.put("/update-surat-masuk/:id", upload.single("file_surat"), authAdmin, suratController.updateSuratMasuk);
router.put("/update-surat-keluar/:id", upload.single("file_surat"), authAdmin, suratController.updateSuratKeluar);
