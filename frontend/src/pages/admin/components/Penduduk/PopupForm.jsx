...
export default function PopupForm({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <div className="p-6">
...
PopupForm.propTypes = {
  formData: PropTypes.shape({
    ...
    agama: PropTypes.string,
    kepalaKeluarga: PropTypes.bool,
  }).isRequired,
