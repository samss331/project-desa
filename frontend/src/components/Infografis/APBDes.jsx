      ...
      datasets: [
        {
          ...
          data: [
            26.79, 83.45, 63.09, 75.82, 92.29, 27.02, 43.63, 57.57, 84.84,
            17.79, 80.07, 33.51,
          ],
          backgroundColor: "rgba(255, 206, 86, 0.7)", // Warna kuning
        },
      ...
      datasets: [
        {
          ...
          data: [
            26.79, 83.45, 63.09, 75.82, 92.29, 27.02, 43.63, 57.57, 64.84,
            17.79, 80.07, 33.51,
          ],
          backgroundColor: "rgba(255, 99, 132, 0.7)", // Warna merah
        },
      ...
      datasets: [
        {
          ...
          backgroundColor: [
            "rgba(54, 162, 235, 0.7)",
            "rgba(255, 99, 132, 0.7)",
          ], // Biru untuk penerimaan, merah untuk pengeluaran
        },
      ],
    };
  ...
  return (
    <div className="space-y-10" style={{ fontFamily: "poppins" }}>
      ...
      <section className="flex flex-col md:grid md:grid-cols-2 md:gap-5 bg-white p-5 rounded-xl shadow-md space-y-6 md:space-y-0">
        {/* Pendapatan Naik */}
        <div
          className="flex items-center justify-between p-4 border rounded-xl bg-gray-50 hover:shadow-[5px_5px_0px_black]
                  hover:-translate-x-1
                  hover:-translate-y-1
                  shadow-md
                  transition-all
        ...
        {/* Surplus / Deposit */}
        <div
          className="col-span-2 flex flex-col md:flex-row items-start md:items-center justify-between p-4 border rounded-xl hover:shadow-[5px_5px_0px_black] bg-gray-50 hover:-translate-x-1
                  hover:-translate-y-1
                  shadow-md
                  transition-all
                  duration-300
      ...
      <section className="space-y-6">
        ...
        <div className="bg-white p-5 rounded-xl shadow-md flex flex-col items-center">
          <h3
            ...
            style={{ fontFamily: "Poppins" }}
          >
            Detail Informasi Pendapatan Desa Tahun 2025
          </h3>
        ...
        <div className="bg-white p-5 rounded-xl shadow-md flex flex-col items-center">
          <h3
            ...
            style={{ fontFamily: "Poppins" }}
          >
            Detail Informasi Belanja Desa Tahun 2025
          </h3>
          <BelanjaBulananChart />
        </div>
        <div className="bg-white p-5 rounded-xl shadow-md flex flex-col items-center">
          <h3
            ...
            style={{ fontFamily: "Poppins" }}
          >
            Detail Informasi Pembiayaan Desa Tahun 2025
          </h3>
          <Pembiayaan />
        </div>
      </section>
