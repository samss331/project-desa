...
const Footer = () => {
  return (
    <footer
      className="bg-gray-900 text-white py-10 mt-10 md:mt-28"
    ...
    >
      <div className="container mx-auto px-6">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 text-center md:text-left mb-6 md:mb-0">
            ...
            <p className="text-gray-400">
              Jl. JalanKu No.99D, Desaku, Kec. Kecamatan, Kab. Kabupaten, Kota
              0000
            </p>
          ...
          <div className="w-full md:w-1/4 text-center md:text-left">
            ...
            <p className="text-gray-400">
              SIDUMAS (Layanan Pengaduan Masyarakat)
            </p>
        ...
        <div className="text-center text-gray-500 mt-6 border-t border-gray-700 pt-4">
          Copyright &copy; 2025 Pemerintah Desa Desaku. All rights reserved.
          <br />
